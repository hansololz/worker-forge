...
success green, failed red, queued/warn amber, cancelled mid-neutral-gray (solid — a deliberate stop
happened), interrupted magenta, continued orange, queued slate, skipped dim-gray (most recessive),
each with a `*-dim` ~14–20% background). Radii 6/9/13px. Type: IBM Plex Sans (body) +
